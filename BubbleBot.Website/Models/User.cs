...
namespace BubbleBot.Website.Models
{
    ...
    public class User
    {
        ...
        public string AvatarUrl => string.IsNullOrEmpty(Avatar) ? Program.Constants.VpsIpAddress + $"/uploads/avatars/default.jpg" : Program.Constants.VpsIpAddress + $"/uploads/avatars/{Avatar}";
