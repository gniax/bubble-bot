    ...
    public class CharacterCreatorExtension : IClearable, IDisposable
    {
        ...
        public async Task BypassTuto()
        {
            ...
            */
            ...
            _account.Game.Character.Inventory.EquipObject(_account.Game.Character.Inventory.GetObjectByGID(TutorialHelper.SecondEquipItems[0]));
            await Task.Delay(200);
            _account.Game.Character.Inventory.EquipObject(_account.Game.Character.Inventory.GetObjectByGID(TutorialHelper.SecondEquipItems[1]));
            await Task.Delay(200);
            _account.Game.Character.Inventory.EquipObject(_account.Game.Character.Inventory.GetObjectByGID(TutorialHelper.SecondEquipItems[2]));
            await Task.Delay(200);
            _account.Game.Character.Inventory.EquipObject(_account.Game.Character.Inventory.GetObjectByGID(TutorialHelper.SecondEquipItems[3]));
            await Task.Delay(200);
            ...
            await Task.Delay(1000);
            Console.WriteLine("On envoie la validation de la quête");
            _account.Network.SendMessage(new QuestObjectiveValidationMessage(1461, 8078));
