        ...
        public static string ToFriendlyString(this BoostableStats stat)
        {
            switch (stat)
            {
                case BoostableStats.AGILITY:
                    return LanguageManager.Translate("226");
                case BoostableStats.CHANCE:
                    return LanguageManager.Translate("227");
                case BoostableStats.INTELLIGENCE:
                    return LanguageManager.Translate("228");
                case BoostableStats.STRENTH:
                    return LanguageManager.Translate("229");
                case BoostableStats.VITALITY:
                    return LanguageManager.Translate("230");
                case BoostableStats.WISDOM:
                    return LanguageManager.Translate("231");
                default:
                    return "-";
            }
        }
